            ...
            <form>
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        <button type="button" class="btn btn btn-success"  style="width:250px;" @click="openAddFormModal">Add tribe</button>
                    </div>
                    <div class="form-group col-md-6">
        ...
        computed: {
            tempDataList() {
                ...
                if(this.comboboxParent) {
                    newDataList = this.filterByParentID(this.dataList[this.panelUrlName], this.comboboxParent.id);
                } else {
